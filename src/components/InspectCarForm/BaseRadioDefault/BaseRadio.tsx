  ...
  return (
    <div className={css[`${radioStyle + "Group"}`]}>
      {/* <fieldset className={css[`${radioStyle + "Fieldset"}`]}> */}
        ...
        {radios.map((radio: { id: React.Key | null | undefined; label: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; }, i: any) => {
          const value = i;
          return (
